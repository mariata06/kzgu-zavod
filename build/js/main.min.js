...
var initRangeSlider = function initRangeSlider() {
  ...
  var range = document.querySelector('.range-slider__progress');
  var priceGap = 0.1;
  priceInput.forEach(function (input) {
    input.addEventListener('input', function (e) {
      var minPrice = parseFloat(priceInput[0].value, 10);
      var maxPrice = parseFloat(priceInput[1].value, 10);
  ...
  rangeInput.forEach(function (input) {
    input.addEventListener('input', function (e) {
      var minVal = parseFloat(rangeInput[0].value, 10);
      var maxVal = parseFloat(rangeInput[1].value, 10);
