...
var _initNavigation = require("./modules/init-navigation");
var _initRangeSlider = require("./modules/init-range-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _initNavigation.initNavigation)();
  // initMap();
  // initRangeSlider();
  (0, _initRangeSlider.initRangeSlider)();
  // Modules
  // ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/init-navigation":9,"./modules/init-range-slider":10,"./modules/input-file/init-upload":15,"./modules/modals/init-modals":18,"./modules/select/custom-select":21,"./utils/ios-vh-fix":24}],2:[function(require,module,exports){
"use strict";
...
var initRangeSlider = function initRangeSlider() {
  var rangeInput = document.querySelectorAll('.range-slider__controls input');
  var priceInput = document.querySelectorAll('.range-slider__price input');
  var rangeAll = document.querySelectorAll('.range-slider__progress');
  var priceGap = 0.1;
  priceInput.forEach(function (input, i) {
    var k = 2 * Math.floor(i / 2); // 0,1 -> 0   2,3-> 2    4,5 -> 4 ...
    input.addEventListener('input', function (e) {
      var range = rangeAll[k / 2];
      var minPrice = parseFloat(priceInput[k].value, 10);
      var maxPrice = parseFloat(priceInput[k + 1].value, 10);
  ...
  rangeInput.forEach(function (input, i) {
    var k = 2 * Math.floor(i / 2); // 0,1 -> 0   2,3-> 2    4,5 -> 4 ...
    input.addEventListener('input', function (e) {
      var range = rangeAll[k / 2];
      var minVal = parseFloat(rangeInput[k].value, 10);
      var maxVal = parseFloat(rangeInput[k + 1].value, 10);
